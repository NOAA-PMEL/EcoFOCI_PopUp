...
#define GPS_SECONDS_BETWEEN_SEARCHES 20	//Number of seconds between GPS Searches to send data	        (nominal GPS_SECONDS_BETWEEN_SEARCHES 20 = 20 seconds)
...
boolean newFile=true;                           //Global variable for sequencing data files when transmitting
boolean beginSDsuccess;                         //Global variable for informing user if SDCard initialized sucessfully
unsigned int pressureOffset = 16384;            //Offset for pressure measurement to reduce bytes of data stored/transmitted
int tempOffset = 21000;                         //Offset for temperature measurement to reduce bytes of data stored/transmitted
int tempRefOffset = 5600;                       //Offset for temperature reference measurement to reduce bytes of data stored/transmitted
int PAROffset = 4700;                           //Offset for PAR measurement to reduce bytes of data stored/transmitted
//********************************************************************************************************************************************************//
