...
DateTime unitStart =  DateTime(17,3,6,14,0,0);             //Date and Time for first sample: 				DateTime(YEAR,MON,DAY,HOUR,MIN,SEC);
...
#define BOTTOM_SAMPLE_INTERVAL 10			    //Interval between bottom samples 				(nominal BOTTOM_SAMPLE_INTERVAL 21600 = 6 hours)
...
void sampleData(char modeSelected){
  ...
  if(modeSelected==1){                                      //If just a bottom sample
    dataFile = SD.open("botdatp.txt", FILE_WRITE);           //open file with write permissions
  }
