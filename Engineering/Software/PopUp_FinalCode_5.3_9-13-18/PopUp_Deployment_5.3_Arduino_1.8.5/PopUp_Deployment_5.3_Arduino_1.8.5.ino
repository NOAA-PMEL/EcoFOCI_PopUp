...
//***************************************************************************************************************************************************************************//
DateTime unitStart =    DateTime(20,8,5,20,30,0);            //Date and Time of first sample: 				                  DateTime(YEAR,MON,DAY,HOUR,MIN,SEC);
DateTime releaseTime =  DateTime(20,8,5,20,50,0);          	 //Date and Time of actual release of burn wire: 	      	DateTime(YEAR,MON,DAY,HOUR,MIN,SEC);
//**************************************************************************************************************************************************************************//
